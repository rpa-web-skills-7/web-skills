	...
	areas: [
		{	name: "문서_객체_모델",  // asset에 폴더 추가하기. 이후 svg파일 이동, 이름바꾸기
			skills: [
				...
				{
					name: "DOM에서_이벤트처리하기",//Module Bundlers
					description: {
				...
				{
					name: "추가한_노드_순서_바꾸거나_삭제하기", //Parcel
					description: {
		...
		},
		{
			...
			{
				name: "웹브라우저를_제어하는_Window객체",//Linters and formatters
				description: {
			...
			{
				name: "브라우저_정보가_담긴_Navigator객체", //Prettier
				description: {
